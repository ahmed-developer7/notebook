# Collapse pass for 01-foundations/02-dotnet-runtime - wraps heavy sections in <details>
# Idempotent: detects already-wrapped sections and skips them.

$ErrorActionPreference = 'Stop'

$chapter = "d:\projects\whenthenonboarding\mastery-guide\01-foundations\02-dotnet-runtime"

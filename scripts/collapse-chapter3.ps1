# Collapse pass for Chapter 3 - wraps heavy sections in <details>
# Idempotent: detects already-wrapped sections and skips them.

$ErrorActionPreference = 'Stop'

$chapter3 = "d:\projects\whenthenonboarding\mastery-guide\03-data-and-persistence"
...
$files = Get-ChildItem -Path $chapter3 -Filter "*.md" -Recurse | Where-Object { $_.Name -ne 'README.md' }
...
foreach ($file in $files) {
    ...
    $relPath = $file.FullName.Replace($chapter3 + '\', '')
